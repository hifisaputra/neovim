...
_G.packer_plugins = {
  ...
  ["projectlaunch.nvim"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/projectlaunch.nvim",
  ...
  ["tailwind-sorter.nvim"] = {
    config = { "\27LJ\2\nº\1\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0005\3\4\0=\3\5\2B\0\2\1K\0\1\0\20on_save_pattern\1\n\0\0\v*.html\t*.js\n*.jsx\n*.tsx\v*.twig\n*.hbs\n*.php\v*.heex\f*.astro\1\0\2\20on_save_enabled\2\14node_path\tnode\nsetup\20tailwind-sorter\frequire\0" },
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/tailwind-sorter.nvim",
